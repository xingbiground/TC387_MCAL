    ...
    group
    {
      ...
      group
      {
        group (ordered, attributes=rw, run_addr=mem:dsram3)
        {
          ...
          select "*InitData.Cpu3.64bit";
          select "*InitData.Cpu3.256bit";
          ...
          select "*InitData.Fast.Cpu3.64bit";
          select "*InitData.Fast.Cpu3.256bit";
          ...
          select "*ClearedData.Fast.Cpu3.64bit";
        ...
        group (ordered, attributes=rw, run_addr=mem:dsram2)
        {
          ...
          select "*InitData.Fast.Cpu2.64bit";
          ...
          select "*ClearedData.Fast.Cpu2.64bit";
        ...
        group (ordered, attributes=rw, run_addr=mem:dsram1)
        {
          ...
          select "*InitData.Fast.Cpu1.64bit";
          ...
          select "*ClearedData.Fast.Cpu1.64bit";
