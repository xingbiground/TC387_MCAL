...
__INTTAB_CPU1 = LCF_INTVEC0_START; /* Done intentionally to load BIV of all CPUs with CPU0 vector table address */
__INTTAB_CPU2 = LCF_INTVEC0_START; /* Done intentionally to load BIV of all CPUs with CPU0 vector table address */
__INTTAB_CPU3 = LCF_INTVEC0_START; /* Done intentionally to load BIV of all CPUs with CPU0 vector table address */
...
MEMORY
{
  ...
  pfls3: ORIGIN=0x80900000, LENGTH=1M
  pfls3_nc: ORIGIN=0xa0900000, LENGTH=1M

  dfls0: ORIGIN=0xaf000000, LENGTH=512K
  ...
  lmuram: ORIGIN=0x90040000, LENGTH=128K
  lmuram_nc: ORIGIN=0xb0040000, LENGTH=128K
}
...
// LMU_NC SECTIONS
  ...
  .InitData.LmuNC.8bit ALIGN(4) : > lmuram_nc
  ...
  .ClearedData.LmuNC.8bit CLEAR ALIGN(4) :    > lmuram_nc
  ...
  .data_cpu3      ALIGN(4)    :   > dsram3
  .InitData.Cpu3.8bit ALIGN(4) :  > .
  .InitData.Cpu3.16bit ALIGN(4)   :   > .
  .InitData.Cpu3.32bit ALIGN(4) : > .
  .InitData.Cpu3.64bit ALIGN(4) : > .
  .InitData.Cpu3.256bit ALIGN(4) : > .
  .InitData.Cpu3.Unspecified ALIGN(4) :   > .
  .InitData.Fast.Cpu3.8bit ALIGN(4) : > .
  .InitData.Fast.Cpu3.16bit ALIGN(4) :    > .
  .InitData.Fast.Cpu3.32bit ALIGN(4) :    > .
  .InitData.Fast.Cpu3.64bit ALIGN(4) :    > .
  .InitData.Fast.Cpu3.256bit ALIGN(4) :    > .
  .InitData.Fast.Cpu3.Unspecified ALIGN(4):   > .

  .bss_cpu3   CLEAR   ALIGN(4)    :   > .
  .ClearedData.Cpu3.8bit CLEAR ALIGN(4) : > .
  .ClearedData.Cpu3.16bit CLEAR ALIGN(4) :    > .
  .ClearedData.Cpu3.32bit CLEAR ALIGN(4) :    > .
  .ClearedData.Cpu3.64bit CLEAR ALIGN(4) :    > .
  .ClearedData.Cpu3.256bit CLEAR ALIGN(32) :   > .
  .ClearedData.Cpu3.Unspecified CLEAR ALIGN(4) :  > .
  .ClearedData.Fast.Cpu3.8bit CLEAR ALIGN(4) :    > .
  .ClearedData.Fast.Cpu3.16bit CLEAR ALIGN(4) :   > .
  .ClearedData.Fast.Cpu3.32bit CLEAR ALIGN(4) :   > .
  .ClearedData.Fast.Cpu3.64bit CLEAR ALIGN(4) :   > .
  .ClearedData.Fast.Cpu3.256bit CLEAR ALIGN(32) :  > .
  .ClearedData.Fast.Cpu3.Unspecified CLEAR ALIGN(4) : > .
  ...
  /* Fixed memory Allocations for _START  for CPU1 to 3*/
  ...
  .Code.Cpu2 ALIGN(2) :    > pfls2
  .Code.Fast.Cpu2 ALIGN(2)    :   > .

  .Code.Cpu3 ALIGN(2) :    > pfls3
  .Code.Fast.Cpu3 ALIGN(2)    :   > .
  ...
  .Const.Cpu3.8bit  ALIGN(4): > pfls3
  .Const.Cpu3.16bit ALIGN(4) :    > .
  .Const.Cpu3.32bit ALIGN(4) :    > .
  .Const.Cpu3.64bit ALIGN(4) :    > .
  .Const.Cpu3.256bit ALIGN(32) :   > .
  .Const.Cpu3.Unspecified ALIGN(4) :  > .
  /* Config Data */
  .Config.Cpu3.8bit ALIGN(4) :    > .
  .Config.Cpu3.16bit ALIGN(4) :   > .
  .Config.Cpu3.32bit ALIGN(4) :   > .
  .Config.Cpu3.64bit ALIGN(4) :   > .
  .Config.Cpu3.256bit ALIGN(32) :  > .
  .Config.Cpu3.Unspecified ALIGN(4) : > .
  ...
  .ROM.InitData.Cpu3.8bit  ROM(.InitData.Cpu3.8bit) : > .
  .ROM.InitData.Cpu3.16bit  ROM(.InitData.Cpu3.16bit) : > .
  .ROM.InitData.Cpu3.32bit  ROM(.InitData.Cpu3.32bit) : > .
  .ROM.InitData.Cpu3.64bit  ROM(.InitData.Cpu3.64bit) : > .
  .ROM.InitData.Cpu3.256bit  ROM(.InitData.Cpu3.256bit) : > .
  .ROM.InitData.Cpu3.Unspecified  ROM(.InitData.Cpu3.Unspecified) : > .
  .ROM.InitData.Fast.Cpu3.8bit  ROM(.InitData.Fast.Cpu3.8bit) : > .
  .ROM.InitData.Fast.Cpu3.16bit  ROM(.InitData.Fast.Cpu3.16bit) : > .
  .ROM.InitData.Fast.Cpu3.32bit  ROM(.InitData.Fast.Cpu3.32bit) : > .
  .ROM.InitData.Fast.Cpu3.64bit  ROM(.InitData.Fast.Cpu3.64bit) : > .
  .ROM.InitData.Fast.Cpu3.256bit  ROM(.InitData.Fast.Cpu3.256bit) : > .
  .ROM.InitData.Fast.Cpu3.Unspecified  ROM(.InitData.Fast.Cpu3.Unspecified) : > .
