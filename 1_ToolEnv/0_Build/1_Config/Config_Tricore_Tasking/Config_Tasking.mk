...
B_TASKING_TRICORE_PATH?= $(TASKING_HOME)\ctc

B_TASKING_TRICORE_CC_OPTIONS= -AGKpvX --core=tc1.6.2 --default-near-size=0 --eabi=BCFHNSW --fp-model=1 \
        --global-type-checking --integer-enumeration --iso=99 -O2 --switch=auto --tradeoff=2

B_TASKING_TRICORE_LD_OPTIONS= --core=mpe:vtc --global-type-checking -OcLtXY
...
B_TASKING_TRICORE_LIBS= -lrt -lc_fpu -lfp_fpu
