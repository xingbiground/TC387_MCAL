...
MEMORY
{
  ...
  pfls3: org = 0x80900000, len = 1M
  pfls3_nc: org = 0xa0900000, len = 1M

  dfls0: org = 0xaf000000, len = 512K
  ...
  lmuram: org = 0x90040000, len = 128K
  lmuram_nc: org = 0xb0040000, len = 128K
...
/*Fixed memory Allocations for stack memory and CSA*/
  ...
  /*Fixed memory Allocations for _START CPU1 to 3*/
