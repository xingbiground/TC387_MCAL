...
/** \brief Length for Ifx_MSC_ID_Bits.MODNUM */
#define IFX_MSC_ID_MODNUM_LEN (16u)

/** \brief Mask for Ifx_MSC_ID_Bits.MODNUM */
#define IFX_MSC_ID_MODNUM_MSK (0xffffu)

/** \brief Offset for Ifx_MSC_ID_Bits.MODNUM */
#define IFX_MSC_ID_MODNUM_OFF (16u)
