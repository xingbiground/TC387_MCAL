 ...
 *
 * \defgroup IfxSfr_Hsct_Registers_BitfieldsMask Bitfields mask and offset
...
/** \addtogroup IfxSfr_Hsct_Registers_BitfieldsMask
 * \{  */
...
/** \brief Length for Ifx_HSCT_ID_Bits.MOD_REV */
#define IFX_HSCT_ID_MOD_REV_LEN (8u)

/** \brief Mask for Ifx_HSCT_ID_Bits.MOD_REV */
#define IFX_HSCT_ID_MOD_REV_MSK (0xffu)

/** \brief Offset for Ifx_HSCT_ID_Bits.MOD_REV */
#define IFX_HSCT_ID_MOD_REV_OFF (0u)

/** \brief Length for Ifx_HSCT_ID_Bits.MOD_TYPE */
#define IFX_HSCT_ID_MOD_TYPE_LEN (8u)

/** \brief Mask for Ifx_HSCT_ID_Bits.MOD_TYPE */
#define IFX_HSCT_ID_MOD_TYPE_MSK (0xffu)

/** \brief Offset for Ifx_HSCT_ID_Bits.MOD_TYPE */
#define IFX_HSCT_ID_MOD_TYPE_OFF (8u)

/** \brief Length for Ifx_HSCT_ID_Bits.MOD_NUM */
#define IFX_HSCT_ID_MOD_NUM_LEN (16u)

/** \brief Mask for Ifx_HSCT_ID_Bits.MOD_NUM */
#define IFX_HSCT_ID_MOD_NUM_MSK (0xffffu)

/** \brief Offset for Ifx_HSCT_ID_Bits.MOD_NUM */
#define IFX_HSCT_ID_MOD_NUM_OFF (16u)
...
#define IFX_HSCT_INIT_SRCF_LEN (2u)

/** \brief Mask for Ifx_HSCT_INIT_Bits.SRCF */
#define IFX_HSCT_INIT_SRCF_MSK (0x3u)

/** \brief Offset for Ifx_HSCT_INIT_Bits.SRCF */
#define IFX_HSCT_INIT_SRCF_OFF (4u)

/** \brief Length for Ifx_HSCT_INIT_Bits.SSCF */
#define IFX_HSCT_INIT_SSCF_LEN (2u)

/** \brief Mask for Ifx_HSCT_INIT_Bits.SSCF */
#define IFX_HSCT_INIT_SSCF_MSK (0x3u)

/** \brief Offset for Ifx_HSCT_INIT_Bits.SSCF */
#define IFX_HSCT_INIT_SSCF_OFF (6u)
...
/** \brief Length for Ifx_HSCT_SLEEPCTRL_Bits.WKUPCNT */
#define IFX_HSCT_SLEEPCTRL_WKUPCNT_LEN (8u)

/** \brief Mask for Ifx_HSCT_SLEEPCTRL_Bits.WKUPCNT */
#define IFX_HSCT_SLEEPCTRL_WKUPCNT_MSK (0xffu)

/** \brief Offset for Ifx_HSCT_SLEEPCTRL_Bits.WKUPCNT */
#define IFX_HSCT_SLEEPCTRL_WKUPCNT_OFF (16u)
...
/** \brief Length for Ifx_HSCT_IFSTAT_Bits.TX_EN */
#define IFX_HSCT_IFSTAT_TX_EN_LEN (1u)

/** \brief Mask for Ifx_HSCT_IFSTAT_Bits.TX_EN */
#define IFX_HSCT_IFSTAT_TX_EN_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_IFSTAT_Bits.TX_EN */
#define IFX_HSCT_IFSTAT_TX_EN_OFF (5u)

/** \brief Length for Ifx_HSCT_CONFIGPHY_Bits.PON */
#define IFX_HSCT_CONFIGPHY_PON_LEN (1u)

/** \brief Mask for Ifx_HSCT_CONFIGPHY_Bits.PON */
#define IFX_HSCT_CONFIGPHY_PON_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_CONFIGPHY_Bits.PON */
#define IFX_HSCT_CONFIGPHY_PON_OFF (0u)

/** \brief Length for Ifx_HSCT_CONFIGPHY_Bits.CORCEN */
#define IFX_HSCT_CONFIGPHY_CORCEN_LEN (5u)

/** \brief Mask for Ifx_HSCT_CONFIGPHY_Bits.CORCEN */
#define IFX_HSCT_CONFIGPHY_CORCEN_MSK (0x1fu)

/** \brief Offset for Ifx_HSCT_CONFIGPHY_Bits.CORCEN */
#define IFX_HSCT_CONFIGPHY_CORCEN_OFF (16u)
...
/** \brief Length for Ifx_HSCT_STATPHY_Bits.TXSA */
#define IFX_HSCT_STATPHY_TXSA_LEN (2u)

/** \brief Mask for Ifx_HSCT_STATPHY_Bits.TXSA */
#define IFX_HSCT_STATPHY_TXSA_MSK (0x3u)

/** \brief Offset for Ifx_HSCT_STATPHY_Bits.TXSA */
#define IFX_HSCT_STATPHY_TXSA_OFF (2u)

/** \brief Length for Ifx_HSCT_STATPHY_Bits.RXSA */
#define IFX_HSCT_STATPHY_RXSA_LEN (2u)

/** \brief Mask for Ifx_HSCT_STATPHY_Bits.RXSA */
#define IFX_HSCT_STATPHY_RXSA_MSK (0x3u)

/** \brief Offset for Ifx_HSCT_STATPHY_Bits.RXSA */
#define IFX_HSCT_STATPHY_RXSA_OFF (4u)
...
/** \brief Length for Ifx_HSCT_IRQ_Bits.MSCE */
#define IFX_HSCT_IRQ_MSCE_LEN (1u)

/** \brief Mask for Ifx_HSCT_IRQ_Bits.MSCE */
#define IFX_HSCT_IRQ_MSCE_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_IRQ_Bits.MSCE */
#define IFX_HSCT_IRQ_MSCE_OFF (13u)
...
/** \brief Length for Ifx_HSCT_IRQEN_Bits.MSCEEN */
#define IFX_HSCT_IRQEN_MSCEEN_LEN (1u)

/** \brief Mask for Ifx_HSCT_IRQEN_Bits.MSCEEN */
#define IFX_HSCT_IRQEN_MSCEEN_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_IRQEN_Bits.MSCEEN */
#define IFX_HSCT_IRQEN_MSCEEN_OFF (13u)
...
/** \brief Length for Ifx_HSCT_IRQCLR_Bits.MSCELR */
#define IFX_HSCT_IRQCLR_MSCELR_LEN (1u)

/** \brief Mask for Ifx_HSCT_IRQCLR_Bits.MSCELR */
#define IFX_HSCT_IRQCLR_MSCELR_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_IRQCLR_Bits.MSCELR */
#define IFX_HSCT_IRQCLR_MSCELR_OFF (13u)
...
/** \brief Length for Ifx_HSCT_TESTCTRL_Bits.TXENS */
#define IFX_HSCT_TESTCTRL_TXENS_LEN (1u)

/** \brief Mask for Ifx_HSCT_TESTCTRL_Bits.TXENS */
#define IFX_HSCT_TESTCTRL_TXENS_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_TESTCTRL_Bits.TXENS */
#define IFX_HSCT_TESTCTRL_TXENS_OFF (0u)

/** \brief Length for Ifx_HSCT_TESTCTRL_Bits.TXDISS */
#define IFX_HSCT_TESTCTRL_TXDISS_LEN (1u)

/** \brief Mask for Ifx_HSCT_TESTCTRL_Bits.TXDISS */
#define IFX_HSCT_TESTCTRL_TXDISS_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_TESTCTRL_Bits.TXDISS */
#define IFX_HSCT_TESTCTRL_TXDISS_OFF (1u)

/** \brief Length for Ifx_HSCT_TESTCTRL_Bits.LLOPTXRX */
#define IFX_HSCT_TESTCTRL_LLOPTXRX_LEN (1u)

/** \brief Mask for Ifx_HSCT_TESTCTRL_Bits.LLOPTXRX */
#define IFX_HSCT_TESTCTRL_LLOPTXRX_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_TESTCTRL_Bits.LLOPTXRX */
#define IFX_HSCT_TESTCTRL_LLOPTXRX_OFF (2u)

/** \brief Length for Ifx_HSCT_TESTCTRL_Bits.PRBSEN */
#define IFX_HSCT_TESTCTRL_PRBSEN_LEN (1u)

/** \brief Mask for Ifx_HSCT_TESTCTRL_Bits.PRBSEN */
#define IFX_HSCT_TESTCTRL_PRBSEN_MSK (0x1u)

/** \brief Offset for Ifx_HSCT_TESTCTRL_Bits.PRBSEN */
#define IFX_HSCT_TESTCTRL_PRBSEN_OFF (3u)
