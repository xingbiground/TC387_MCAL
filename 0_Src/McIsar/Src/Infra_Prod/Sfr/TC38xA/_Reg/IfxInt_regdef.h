...
typedef volatile struct _Ifx_INT
{
       ...
       Ifx_UReg_8Bit                       reserved_C[4];          /**< \brief C, \internal Reserved */
       Ifx_INT_SRB                         SRB[4];                 /**< \brief 10, Service Request Broadcast Register ${x}*/
       ...
       Ifx_INT_ACCEN                       ACCEN[4];               /**< \brief 100, Access Enable covering SRB${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_120[96];       /**< \brief 120, \internal Reserved */
       Ifx_INT_ACCEN_SRC                   ACCEN_SRC[5];           /**< \brief 180, Access Enable covering all SRCx[31:16] mapped to ICU${x}, Register 1*/
       Ifx_UReg_8Bit                       reserved_1A8[88];       /**< \brief 1A8, \internal Reserved */
       Ifx_INT_CH                          CH[5];                  /**< \brief 200, */
       Ifx_UReg_8Bit                       reserved_250[3504];     /**< \brief 250, \internal Reserved */
} Ifx_INT;
