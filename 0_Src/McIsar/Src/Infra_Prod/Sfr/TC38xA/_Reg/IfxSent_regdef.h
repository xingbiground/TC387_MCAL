...
typedef volatile struct _Ifx_SENT
{
       ...
       Ifx_SENT_RDR                        RDR[25];                /**< \brief 80, Receive Data Register ${x}*/
       ...
       Ifx_SENT_CH                         CH[25];                 /**< \brief 100, Reserved*/
       Ifx_UReg_8Bit                       reserved_740[832];      /**< \brief 740, \internal Reserved */
       Ifx_SENT_RTS                        RTS[25];                /**< \brief A80, Receive Time Stamp Register ${x}*/
       Ifx_UReg_8Bit                       reserved_AE4[28];       /**< \brief AE4, \internal Reserved */
} Ifx_SENT;
