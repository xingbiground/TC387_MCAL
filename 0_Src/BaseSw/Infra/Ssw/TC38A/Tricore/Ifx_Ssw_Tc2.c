...
#   define IFX_CFG_SSW_ENABLE_TRICORE2_PCACHE (1)  /**< Program Cache enabled by default*/
#endif
#ifndef IFX_CFG_SSW_ENABLE_TRICORE2_DCACHE
#   define IFX_CFG_SSW_ENABLE_TRICORE2_DCACHE (1)  /**< Data Cache enabled by default*/
#endif
/*******************************************************************************
...
void __Core2_start(void)
{
    ...
    (void)Ifx_Ssw_startCore(&MODULE_CPU3, (unsigned int)&__Core3_start);       /*The status returned by function call is ignored */
#endif
